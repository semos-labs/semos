...
Resolve all [Responsive](../../types/breakpoint#responsive) values in a [Style](../../types/style) to produce a
[ResolvedStyle](../../types/resolved-style) with only concrete values.

## Parameters

| Parameter | Type | Description |
| ------ | ------ | ------ |
| `style` | [`Style`](../../types/style) | The (possibly responsive) style object from a component. |
