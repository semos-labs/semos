...
or debug tools. Respects the current [FocusScope](../focus-scope) trap.

## Returns

[`FocusRegistryValue`](#focus-registry-value) \| `null`
...
| <a id="layout"></a> `layout` | [`LayoutRect`](../../core/layout-rect) | Current layout (position, size) |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="elements"></a> `elements` | [`FocusableElement`](#focusable-element)[] | All currently registered focusable elements |
