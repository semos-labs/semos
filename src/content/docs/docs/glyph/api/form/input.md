...
| <a id="focusedstyle"></a> `focusedStyle?` | [`Style`](../../core/style) | Style when focused (merged with style). |
...
| <a id="style"></a> `style?` | [`Style`](../../core/style) | Base style for the input container. |
| <a id="type"></a> `type?` | [`InputType`](#input-type) | Input type for validation: - "text" (default): accepts any character - "number": only accepts digits, decimal point, and minus sign |
