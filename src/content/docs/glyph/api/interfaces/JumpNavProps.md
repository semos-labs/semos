...
| <a id="hintbg"></a> `hintBg?` | [`Color`](../type-aliases/Color.md) | Color for hint background (default: "yellow") |
| <a id="hintchars"></a> `hintChars?` | `string` | Characters to use for hints (default: "asdfghjklqwertyuiopzxcvbnm") |
| <a id="hintfg"></a> `hintFg?` | [`Color`](../type-aliases/Color.md) | Color for hint text (default: "black") |
| <a id="hintstyle"></a> `hintStyle?` | [`Style`](Style.md) | Style for the hint labels |
