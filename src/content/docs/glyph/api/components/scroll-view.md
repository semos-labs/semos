...
| Parameter | Type |
| ------ | ------ |
| `__namedParameters` | [`ScrollViewProps`](scroll-view.md#scroll-view-props) |
...
Props for the [ScrollView](scroll-view.md) component.
...
| <a id="focusedstyle"></a> `focusedStyle?` | [`Style`](../types/style.md) | Style applied when ScrollView is focused |
...
| <a id="style"></a> `style?` | [`Style`](../types/style.md) | - |
