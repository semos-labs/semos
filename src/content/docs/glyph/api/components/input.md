...
Props for the [Input](input.md) component.
...
| <a id="focusedstyle"></a> `focusedStyle?` | [`Style`](../types/style.md) | Style when focused (merged with style). |
...
| <a id="style"></a> `style?` | [`Style`](../types/style.md) | Base style for the input container. |
| <a id="type"></a> `type?` | [`InputType`](input.md#input-type) | Input type for validation: - "text" (default): accepts any character - "number": only accepts digits, decimal point, and minus sign |
