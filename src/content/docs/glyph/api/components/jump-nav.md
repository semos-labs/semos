...
| Parameter | Type |
| ------ | ------ |
| `__namedParameters` | [`JumpNavProps`](jump-nav#jump-nav-props) |
...
Props for the [JumpNav](jump-nav) component.
...
| <a id="hintbg"></a> `hintBg?` | [`Color`](../../types/color) | Color for hint background (default: "yellow") |
| <a id="hintchars"></a> `hintChars?` | `string` | Characters to use for hints (default: "asdfghjklqwertyuiopzxcvbnm") |
| <a id="hintfg"></a> `hintFg?` | [`Color`](../../types/color) | Color for hint text (default: "black") |
| <a id="hintstyle"></a> `hintStyle?` | [`Style`](../../types/style) | Style for the hint labels |
