...
| <a id="bg"></a> `bg?` | [`Color`](color.md) | Background color. |
| <a id="bold"></a> `bold?` | `boolean` | Render text in bold. |
| <a id="border"></a> `border?` | [`BorderStyle`](style.md#border-style) | Border drawing style. |
| <a id="bordercolor"></a> `borderColor?` | [`Color`](color.md) | Border color (requires `border` to be set). |
| <a id="bottom"></a> `bottom?` | [`DimensionValue`](style.md#dimension-value) | Bottom offset for absolute positioning. |
| <a id="clip"></a> `clip?` | `boolean` | Clip overflowing children (used internally by ScrollView). |
| <a id="color"></a> `color?` | [`Color`](color.md) | Text (foreground) color. Inherited by children. |
...
| <a id="height"></a> `height?` | [`DimensionValue`](style.md#dimension-value) | Height in cells or percentage of parent. |
| <a id="inset"></a> `inset?` | [`DimensionValue`](style.md#dimension-value) | Shorthand for top/right/bottom/left simultaneously. |
...
| <a id="left"></a> `left?` | [`DimensionValue`](style.md#dimension-value) | Left offset for absolute positioning. |
...
| <a id="right"></a> `right?` | [`DimensionValue`](style.md#dimension-value) | Right offset for absolute positioning. |
| <a id="textalign"></a> `textAlign?` | [`TextAlign`](style.md#text-align) | Horizontal text alignment within the container. |
| <a id="top"></a> `top?` | [`DimensionValue`](style.md#dimension-value) | Top offset for absolute positioning. |
| <a id="underline"></a> `underline?` | `boolean` | Render text with underline. |
| <a id="width"></a> `width?` | [`DimensionValue`](style.md#dimension-value) | Width in cells or percentage of parent. |
| <a id="wrap"></a> `wrap?` | [`WrapMode`](style.md#wrap-mode) | Text wrapping mode. |
...
Border drawing style for [Style.border](style.md#border).
...
Text wrapping mode for [Style.wrap](style.md#wrap).
