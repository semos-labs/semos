          ...
          sidebar: [
              ...
              },
              {
                  ...
                  items: [
                      ...
                      { label: "Font", link: "/docs/attyx/font/" },
                      { label: "Cursor", link: "/docs/attyx/cursor/" },
                      { label: "Window", link: "/docs/attyx/window/" },
                      { label: "Shell", link: "/docs/attyx/shell/" },
                      { label: "Scrollback", link: "/docs/attyx/scrollback/" },
                      ...
                      { label: "Tabs & Splits", link: "/docs/attyx/tabs-and-splits/" },
                      { label: "Popups", link: "/docs/attyx/popups/" },
                      { label: "Status Bar", link: "/docs/attyx/status-bar/" },
                      { label: "Sessions", link: "/docs/attyx/sessions/" },
                      { label: "Visual Mode", link: "/docs/attyx/visual-mode/" },
